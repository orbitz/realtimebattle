/************************************************************************
    $Id: columbusservertrackstate.h,v 1.1 2005/07/29 10:59:51 krolfy Exp $
    ...
    $Log: columbusservertrackstate.h,v $
...
#ifndef COLUMBUSSERVERTRACKSTATE_H
#define COLUMBUSSERVERTRACKSTATE_H
...
namespace Columbus {
	...
	class ColumbusServerTrackState: public ColumbusServerBaseState {
	public:
		...
		ColumbusServerTrackState(ServerCoordinator* c,ColumbusInternalServerSpecificRepository* columbusssp, ColumbusSharedServerSpecificRepository* columbussharedssp) throw (StrategyException,bad_exception);

		virtual ~ColumbusServerTrackState () throw();
