/************************************************************************
    $Id: columbusserverbasestate.h,v 1.8 2005/08/23 15:37:05 krolfy Exp $
    ...
    $Log: columbusserverbasestate.h,v $
    ...
    *** empty log message ***
    ...
    Revision 1.5  2005/07/28 08:19:10  krolfy
    Most of the server side ready

    Revision 1.4  2005/01/25 15:21:27  krolfy
...
#ifndef COLUMBUSSERVERBASICSTATE_H
#define COLUMBUSSERVERBASICSTATE_H
...
namespace Columbus {
	...
	*
	* This class is the base of all columbus server states. Here, the default actions, that will be done by every state
	...
	*/ 
	class ColumbusServerBaseState: public Strategies::ServerState {
	public:

		/**
		 * Tell the bot where to drive
		 */
		virtual void sendNavigationServerTips() throw(bad_exception) = 0;

		/**
		 * Defines what to do with an enemy found.
		 * @param pos the position of the enemy
		 */
		virtual void handleEnemy(const General::Position& pos) throw(bad_exception) = 0;
		 ...
		 */
		virtual void makeFootPrint(const General::Position& pos,const General::Position& speed) throw(bad_exception) = 0;

		ColumbusServerBaseState(ServerCoordinator* c,ColumbusInternalServerSpecificRepository* columbusssp, ColumbusSharedServerSpecificRepository* columbussharedssp) throw (StrategyException,bad_exception);

		virtual ~ColumbusServerBaseState () throw();
