/************************************************************************
    $Id: columbusclientbasestate.h,v 1.3 2005/08/02 12:18:42 krolfy Exp $
    ...
    $Log: columbusclientbasestate.h,v $
...
#ifndef ColumbusCLIENTBASICSTATE_H
#define ColumbusCLIENTBASICSTATE_H

#include "../../gamecontrol/gamecontrolnamespace.h"
#include "../../strategies/clientstate.h"
#include "../general/generalnamespace.h"
...
namespace Columbus {
	...
	*/ 
	class ColumbusClientBaseState: public Strategies::ClientState {
	public:
		/**
		 * Change direction according to a server driving hint
		 * @param pos a point the direction shall be changed towards
		 */
		virtual void driveTowards(const General::Position& pos) throw(bad_exception);

		ColumbusClientBaseState(ClientCoordinator* i,ColumbusClientSpecificRepository* columbuscsp,const GameOptionsRepository* go) throw (StrategyException,bad_exception);
		virtual  ~ColumbusClientBaseState () throw();
		/**
