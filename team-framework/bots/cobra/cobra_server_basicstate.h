...
#ifndef cobra_SERVERBASICSTATE_H
#define cobra_SERVERBASICSTATE_H
...
/**
 *	This class is the base of all cobra server states. Here, the default actions, that will be done by every state
 ...
 */
	...
	class cobra_ServerBasicState: public Strategies::ServerState {
	public:
		cobra_ServerBasicState(ServerCoordinator* i, cobra_InternalServerSpecificRepository* cobra_issp, cobra_SharedServerSpecificRepository* cobra_sharedssp) throw (StrategyException,bad_exception);
		virtual ~cobra_ServerBasicState () throw();
	...
	private:
		cobra_SharedServerSpecificRepository* _cobra_sharedssp;
		General::RobotInfo _robot;
//		unsigned int _myID; changed to _robot.ID
//		Position _curPos;   changed to _robot.pos
//		double _ownAngle;   changed to _robot.dirRobot
	};
}
